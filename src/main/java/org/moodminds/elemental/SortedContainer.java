 ...
 *
 * @param <V> the type of elements contained
 */
public interface SortedContainer<V> extends Container<V> {
     ...
     * Returns {@code null} if this Container relies on the {@linkplain Comparable natural ordering} of its elements.
     *
     ...
     */
    SortedContainer<V> sub(V fromElement, V toElement);
     ...
     */
    SortedContainer<V> head(V toElement);
     ...
     *         bounds of that range
     */
    SortedContainer<V> tail(V fromElement);
}

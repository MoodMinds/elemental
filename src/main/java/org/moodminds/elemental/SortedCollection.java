 ...
 */
public interface SortedCollection<V> extends Collection<V>, SortedContainer<V> {
     ...
     */
    @Override
    SortedCollection<V> sub(V fromElement, V toElement);
     ...
     */
    @Override
    SortedCollection<V> head(V toElement);
     ...
     */
    @Override
    SortedCollection<V> tail(V fromElement);
}

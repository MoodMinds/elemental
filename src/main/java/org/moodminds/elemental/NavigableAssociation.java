 ...
 */
public interface NavigableAssociation<K, V, KV extends KeyValue<K, V>> extends SortedAssociation<K, V, KV> {
     ...
     */
    NavigableAssociation<K, V, ?> subAssociation(K fromKey, boolean fromInclusive, K toKey,   boolean toInclusive);
     ...
     *         bounds of the range
     */
    NavigableAssociation<K, V, ?> headAssociation(K toKey, boolean inclusive);
     ...
     *         bounds of the range
     */
    NavigableAssociation<K, V, ?> tailAssociation(K fromKey, boolean inclusive);
}

 ...
 */
public interface SortedAssociation<K, V, KV extends KeyValue<K, V>> extends Association<K, V, KV> {
     ...
     * If this Association utilizes the natural ordering of its keys, it returns {@code null}.
     *

...
public interface ConcurrentNavigableMap<K, V> extends ConcurrentMap<K, V>, NavigableMap<K, V>,
     ...
     */
    @Override
    default ConcurrentNavigableMap<K, V> subAssociation(K fromKey, boolean fromInclusive, K toKey, boolean toInclusive) {
        return (ConcurrentNavigableMap<K, V>) NavigableMap.super.subAssociation(fromKey, fromInclusive, toKey, toInclusive);
    }
     ...
     */
    @Override
    default ConcurrentNavigableMap<K, V> headAssociation(K toKey, boolean inclusive) {
        return (ConcurrentNavigableMap<K, V>) NavigableMap.super.headAssociation(toKey, inclusive);
    }
     ...
     */
    @Override
    default ConcurrentNavigableMap<K, V> tailAssociation(K fromKey, boolean inclusive) {
        return (ConcurrentNavigableMap<K, V>) NavigableMap.super.tailAssociation(fromKey, inclusive);
    }

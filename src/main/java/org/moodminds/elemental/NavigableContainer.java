 ...
 */
public interface NavigableContainer<V> extends SortedContainer<V> {
     ...
     */
    default V lower(V e) {
        Iterator<V> iterator = lowerAll(e); return iterator.hasNext() ? iterator.next() : null;
    }
     ...
     */
    default V floor(V e) {
        Iterator<V> iterator = floorAll(e); return iterator.hasNext() ? iterator.next() : null;
    }
    ...
    default V ceiling(V e) {
        Iterator<V> iterator = ceilingAll(e); return iterator.hasNext() ? iterator.next() : null;
    }
    ...
    default V higher(V e) {
        Iterator<V> iterator = higherAll(e); return iterator.hasNext() ? iterator.next() : null;
    }
     ...
     */
    NavigableContainer<V> descending();
     ...
     */
    NavigableContainer<V> sub(V fromElement, boolean fromInclusive, V toElement, boolean toInclusive);
     ...
     */
    NavigableContainer<V> head(V toElement, boolean inclusive);
     ...
     *         bounds of that range
     */
    NavigableContainer<V> tail(V fromElement, boolean inclusive);
}

...
public interface NavigableMap<K, V> extends SortedMap<K, V>, NavigableAssociation<K, V, Map.Entry<K, V>>,
     ...
     */
    @Override
    default NavigableMap<K, V> subAssociation(K fromKey, boolean fromInclusive, K toKey, boolean toInclusive) {
     ...
     */
    @Override
    default NavigableMap<K, V> headAssociation(K toKey, boolean inclusive) {
     ...
     */
    @Override
    default NavigableMap<K, V> tailAssociation(K fromKey, boolean inclusive) {

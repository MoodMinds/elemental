 ...
 */
public interface NavigableCollection<V> extends SortedCollection<V>, NavigableContainer<V> {
     ...
     */
    @Override
    NavigableCollection<V> descending();
     ...
     */
    @Override
    NavigableCollection<V> sub(V fromElement, boolean fromInclusive, V toElement, boolean toInclusive);
     ...
     */
    @Override
    NavigableCollection<V> head(V toElement, boolean inclusive);
     ...
     */
    @Override
    NavigableCollection<V> tail(V fromElement, boolean inclusive);
}

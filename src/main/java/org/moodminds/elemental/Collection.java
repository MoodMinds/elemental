...
/**
 * A mutative extension of the {@link Container} interface, which also extends
 * the {@link java.util.Collection} interface.
 *
 * @param <V> the type of elements
 */
public interface Collection<V> extends Container<V>, java.util.Collection<V> {
    ...
    default boolean addAll(Container<? extends V> c) {
        return addAll((Iterable<? extends V>) c);
    }
    ...
    default boolean addAll(Collection<? extends V> c) {
        return addAll((java.util.Collection<? extends V>) c);
    }
    ...
    default boolean retainAll(Container<?> c) {
        requireNonNull(c); return removeIf(v -> !c.contains(v));
    }

...
- **Sequence**: Extends **Ended** and **Ordered**, providing an immutable list-like structure.
...
of elements matching a provided example object, while the `getAll` method provides an **java.util.Iterator** for all elements that match
